Python package should have all the usual. main.py should execute everything. Have folders for input, output, docker stuff if deemed necessary, src/model, src/utils
